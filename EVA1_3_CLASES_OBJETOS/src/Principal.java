...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        // Nombre de la clase, nombre del ob
...
//Dentro de los parentesis se envian los datos hacia el objeto
                //Para crear un objeto siempre debe ser usada la intrucción new
